...
mod4 = "mod4"                                     # Sets mod key to SUPER/WINDOWS
...
keys = [
         ...
         Key([mod4], "e",
             lazy.spawn("rofi -show run -font 'JetBrainsMono Nerd Font 12'"),
             desc='Run Launcher'
             ),
         Key([mod4], "Tab",
             lazy.next_layout(),
...
#            ),
         Key(["mod4", "shift"], "s",
             lazy.spawn("/home/jackson/.local/bin/screenshot.sh"),
             desc='Screenshot'
             ),
         ### Window controls
         Key([mod4], "k",
        ...
        ### Audio is needed
         Key([], "XF86AudioRaiseVolume", lazy.spawn("amixer -q sset Master 1%+"), desc='Increase audio'),
         Key([], "XF86AudioLowerVolume", lazy.spawn("amixer -q sset Master 1%-"), desc='Decrease audio'),
         Key([], "XF86AudioMute", lazy.spawn("amixer -q sset Master toggle"), desc='Mute audio'),

         Key([], "XF86AudioPlay", lazy.spawn("playerctl play-pause"), desc='Play music'),
...
for i, (name, kwargs) in enumerate(group_names, 1):
    keys.append(Key([mod4], str(i), lazy.group[name].toscreen()))        # Switch to another group
    keys.append(Key([mod4, "shift"], str(i), lazy.window.togroup(name))) # Send current window to another group
