...
globalkeys = my_table.join(
    ...
    -- screenshots
    awful.key({ }, "Print", function () awful.util.spawn("scrot 'ArchLinux-%Y-%m-%d-%s_screenshot_$wx$h.jpg' -e 'mv $f $$(xdg-user-dir PICTURES)/Screenshots/'") end,
    ...
    awful.key({ modkey, "Shift"  }, "s", function() awful.spawn.easy_async_with_shell("maim -u -s -n -m 1 | xclip -selection clipboard -t image/png") end,
        {description = "area/selected screenshot", group = "screenshots"}),

    -- Personal keybindings}}}

    -- My launchers
    awful.key({ modkey, "Shift" }, "f", function () awful.spawn("firefox -P") end, {description = "firefox", group = "launchers"}),

    awful.key({ modkey, "Shift" }, "b", function () awful.spawn("brave") end, {description = "brave", group = "launchers"}),

    awful.key({ modkey, "Shift" }, "e", function () awful.spawn("nemo") end, {description = "nemo", group = "launchers"}),
...
--        {description = "go back", group = "client"}),
    ...
    awful.key({ "Control"           }, "`", function () awful.spawn( terminal ) end,
              {description = "terminal without fish shell", group = "super"}),
