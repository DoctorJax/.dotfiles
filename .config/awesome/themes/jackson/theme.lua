...
local theme                                     = {}
theme.dir                                       = os.getenv("HOME") .. "/.config/awesome/themes/jackson"
theme.font                                      = "mononoki Regular Nerd Font Bold 11"
theme.taglist_font                              = "mononoki Nerd Font Bold 15"
...
theme.border_focus                              = pywaltheme.color1
